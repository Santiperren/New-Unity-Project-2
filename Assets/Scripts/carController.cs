...
public class carController : MonoBehaviour
{
    ...
    void Start()
    {
            ...
            if (GameManager.Instance.autoUnoSkin == 0)
            {
            ...
            else if (GameManager.Instance.autoUnoSkin == 1)
            {
            ...
            else if (GameManager.Instance.autoUnoSkin == 2)
            {
                autoRojo1.SetActive(false);
            ...
            else if (GameManager.Instance.autoUnoSkin == 3)
            {
                autoRojo1.SetActive(false);
                autoVioleta1.SetActive(false);
            ...
            else if (GameManager.Instance.autoUnoSkin == 4)
            {
                autoRojo1.SetActive(false);
                autoVioleta1.SetActive(false);
                autoRosa1.SetActive(false);
            ...
            else if (GameManager.Instance.autoUnoSkin == 5)
            {
                autoRojo1.SetActive(false);
                autoVioleta1.SetActive(false);
                autoRosa1.SetActive(false);
